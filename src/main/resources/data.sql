...
INSERT INTO respostas(id, data_criacao, descricao, situacao, duvida_id, usuario_id) VALUES (1,NOW(),'MENSAGEM DA DÚVIDA',FALSE, 1, 1);
INSERT INTO respostas(id, data_criacao, descricao, situacao, duvida_id, usuario_id) VALUES (2,NOW(),'MENSAGEM DA DÚVIDA',FALSE, 2, 1);
INSERT INTO respostas(id, data_criacao, descricao, situacao, duvida_id, usuario_id) VALUES (3,NOW(),'MENSAGEM DA DÚVIDA',FALSE, 3, 1);