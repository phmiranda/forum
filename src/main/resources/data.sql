...
INSERT INTO usuarios(id, documento, email, nome, senha, situacao) VALUES(1, '70436011000', 'admin@email.com.br', 'Administrador', '$2a$04$ygKK8TiwMgUA64teTjLk0eA5QBTRQX/Xym54qzoCk6dbd.dt8Y0OK', 'INATIVO');
INSERT INTO usuarios(id, documento, email, nome, senha, situacao) VALUES(2, '60172076013', 'debora.silva@email.com.br', 'Débora Viana da Silva', '$2a$04$ygKK8TiwMgUA64teTjLk0eA5QBTRQX/Xym54qzoCk6dbd.dt8Y0OK', 'INATIVO');
INSERT INTO usuarios(id, documento, email, nome, senha, situacao) VALUES(3, '33721917065', 'alexandre.silva@email.com.br', 'Alexander Vasconcelos da Silva', '$2a$04$ygKK8TiwMgUA64teTjLk0eA5QBTRQX/Xym54qzoCk6dbd.dt8Y0OK', 'INATIVO');
