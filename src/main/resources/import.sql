...
INSERT INTO topicos(id, titulo, mensagem, data_criacao, topico_status, usuario_id, curso_id) VALUES(4, 'Dúvida #04', 'MENSAGEM DA DÚVIDA', NOW(), 'NAO_RESPONDIDO', 1, 4);
INSERT INTO topicos(id, titulo, mensagem, data_criacao, topico_status, usuario_id, curso_id) VALUES(5, 'Dúvida #05', 'MENSAGEM DA DÚVIDA', NOW(), 'NAO_RESPONDIDO', 2, 5);
INSERT INTO topicos(id, titulo, mensagem, data_criacao, topico_status, usuario_id, curso_id) VALUES(6, 'Dúvida #06', 'MENSAGEM DA DÚVIDA', NOW(), 'NAO_RESPONDIDO', 3, 5);
INSERT INTO topicos(id, titulo, mensagem, data_criacao, topico_status, usuario_id, curso_id) VALUES(7, 'Dúvida #07', 'MENSAGEM DA DÚVIDA', NOW(), 'NAO_RESPONDIDO', 1, 4);
INSERT INTO topicos(id, titulo, mensagem, data_criacao, topico_status, usuario_id, curso_id) VALUES(8, 'Dúvida #08', 'MENSAGEM DA DÚVIDA', NOW(), 'NAO_RESPONDIDO', 2, 3);
INSERT INTO topicos(id, titulo, mensagem, data_criacao, topico_status, usuario_id, curso_id) VALUES(9, 'Dúvida #09', 'MENSAGEM DA DÚVIDA', NOW(), 'NAO_RESPONDIDO', 3, 2);
...
INSERT INTO respostas(id, data_criacao, mensagem, solucao, topico_id, usuario_id) VALUES (4,NOW(),'MENSAGEM DA DÚVIDA',FALSE, 4, 1);
INSERT INTO respostas(id, data_criacao, mensagem, solucao, topico_id, usuario_id) VALUES (5,NOW(),'MENSAGEM DA DÚVIDA',FALSE, 5, 2);
INSERT INTO respostas(id, data_criacao, mensagem, solucao, topico_id, usuario_id) VALUES (6,NOW(),'MENSAGEM DA DÚVIDA',FALSE, 6, 3);
INSERT INTO respostas(id, data_criacao, mensagem, solucao, topico_id, usuario_id) VALUES (7,NOW(),'MENSAGEM DA DÚVIDA',FALSE, 7, 1);
INSERT INTO respostas(id, data_criacao, mensagem, solucao, topico_id, usuario_id) VALUES (8,NOW(),'MENSAGEM DA DÚVIDA',FALSE, 8, 2);
INSERT INTO respostas(id, data_criacao, mensagem, solucao, topico_id, usuario_id) VALUES (9,NOW(),'MENSAGEM DA DÚVIDA',FALSE, 9, 3);